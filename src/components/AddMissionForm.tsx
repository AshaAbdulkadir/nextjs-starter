...
import { PLATFORMS, STATUSES, type Platform, type Status } from "@/lib/missions";
...
export default function AddMissionForm() {
  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-12">
      <div className="rounded-2xl border border-[color:var(--border)] bg-[color:var(--panel)]/80 p-6 sm:p-8">
        ...
        <p className="mt-1 text-sm text-[color:var(--muted)]">
          Log a new cloud project. Saved locally for now — database wiring lands in phase two.
        </p>
        ...
        >
          <Field label="Mission Name" htmlFor="mission-name" required>
            <input
              ...
              placeholder="e.g. Mission Log API"
              required
          ...
          <div className="sm:col-span-2">
            <Field label="Description" htmlFor="mission-description">
              <textarea
            ...
            <p className="text-xs mono text-[color:var(--muted)]">
              {confirmed ? (
                <span className="text-emerald-300">
                  ✓ Mission logged: <strong>{confirmed}</strong>
                </span>
              ) : (
